function PrivacyPolicy() {
  return (
    <div className="m-56 mt-20 text-center">
      ...
      <ul>
        ...
        <li>
          <p>
            Application refers to Diary Quest, the software program provided by
            the Company.
          </p>
        </li>
        <li>
          <p>
            ...
            refers to Diary Quest.
          </p>
        </li>
        <li>
          <p>Country refers to: Japan</p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://diary.haru0u0.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://diary.haru0u0.com/contact
          </a>
        </li>
      </ul>
    </div>
